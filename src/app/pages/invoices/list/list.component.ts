  ...
  export class ListComponent {
    ...
    constructor(private modalService: NgbModal, public service: PaginationService,
      ...
      private store: Store<{ data: RootReducerState }>, private datePipe: DatePipe ,private commandeService:CommandeService) {
    }
    ...
    fetchCommandes() {
      this.commandeService.getCommandes().subscribe((data: any[]) => {
        this.commandes = data;
       
        this.allCommandes = cloneDeep(data);
        this.commandes = this.service.changePage(this.allCommandes);
      });
    }
    ...
    */
    ...
    performSearch(): void {
      this.searchResults = this.allCommandes.filter((item: any) => {
        return (
          item.name.toLowerCase().includes(this.searchTerm.toLowerCase())
        );
      });
      this.commandes = this.service.changePage(this.searchResults)
    }
