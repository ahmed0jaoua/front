...
@Component({
  ...
  templateUrl: './typecoli.component.html',
  styleUrls: ['./typecoli.component.scss']
})

/**
 * Customers Component
 */
export class TypeColiComponent {
  ...
  constructor(private modalService: NgbModal,
    ...
    private restApiService: restApiService, private store: Store<{ data: RootReducerState }>, private UtilisateurService: UtilisateurService, private SiteService: SiteService , private TypeColisService : TypeColisService     ) {
  }
  getModalContent() {
  ...
  updatetype(){
    ...
    this.TypeColisService.update(this.selectedUtilisateur.id,updatedutilisateur).subscribe({
      next: (data) => {
   ...
   // this.modalService.open( {  size: 'md', centered: true });
    ...
    const uti  =  this.uts.find(utilisateur => utilisateur.id === id);
     ...
     this.libelle= uti.libelle
  
 
  }

  deletetype (){
    this.TypeColisService.delete(this.deleteId).subscribe({
      next: (data) => {
        this.uts = data;
