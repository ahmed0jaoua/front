...
@Component({
  ...
  templateUrl: './typepaiment.component.html',
  styleUrls: ['./typepaiment.component.scss']
})

/**
 * Customers Component
 */
export class TypePaiementComponent {
  ...
  getTypePaiment() {
    this.TypePaiementService.getTypePaiement().subscribe(data => {
      this.uts = data;
  ...
  updatetype() {
    ...
    this.TypePaiementService.update(this.selectedUtilisateur.id, updatedutilisateur).subscribe({
      next: (data) => {
  ...
  deletetype() {
    this.TypePaiementService.delete(this.deleteId).subscribe({
      next: (data) => {
        this.uts = data;
  ...
  createtypecoli() {
    ...
    this.TypePaiementService.add(type).subscribe({
      next: (data) => {
